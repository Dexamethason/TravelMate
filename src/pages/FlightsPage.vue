...
const filteredFlights = computed(() => {
  ...
  return allFlights.value.filter(flight => {
    ...
    if (filters.value.airlines.length > 0 && !(filters.value.airlines as string[]).includes(flight.airlineCode)) {
      return false
    }
...
<template>
  <AppLayout>
      ...
      <div class="container mx-auto">
        ...
        <div class="p-3 sm:p-4 mb-6 sm:mb-8">
          ...
          <p class="text-gray-600 text-sm sm:text-base mt-1">
            ...
            · {{ searchParams.passengers }} {{ searchParams.passengers === 1 ? 'pasażer' : 'pasażerów' }}
          </p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-6 sm:gap-8">
          ...
          <div class="flex-1">
            ...
            <div class="bg-white p-3 sm:p-5 rounded-lg shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3" style="margin-bottom: 25px;">
              <div class="p-1 sm:p-2">
                <span class="text-gray-600 font-medium">{{ sortedFlights.length }} {{ sortedFlights.length === 1 ? 'wynik' : 'wyników' }}</span>
              </div>
            ...
            <!-- No results message -->
            <div v-if="sortedFlights.length === 0" class="bg-white p-8 rounded-lg shadow-md text-center">
    ...
    <section v-else class="py-12 sm:py-20 px-4 text-center">
      <div class="container mx-auto max-w-3xl">
        ...
        />
        <h2 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Wyszukaj loty, by zobaczyć dostępne połączenia</h2>
        <p class="text-gray-600 mb-6 sm:mb-8">
          Wypełnij formularz wyszukiwania, aby znaleźć najlepsze oferty lotów.
          Możesz filtrować wyniki według ceny, liczby przesiadek i czasu lotu.
        </p>
      </div>
    </section>
  </AppLayout>
